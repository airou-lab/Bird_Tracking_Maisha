...
parser.add_argument('--root', default='/home/airlab/mbird/GoProUpClose', help='Path to image folder')
parser.add_argument('--annfile', default='/home/airlab/avian-mesh-master/data/cowbird/annotations/person_keypoints_default.json', help='Path to annotation')
...
if __name__ == '__main__':
   ...
   # imgfile = coco.loadImgs(available_Ids[args.index])[0]['file_name']
    ...
    # Visualization
    confident = (output['scores'] > 0.50)
    bird = (output['labels'] == 1)
    select = confident * bird
    masks = output['masks'][select].squeeze(1) > 0.5
    masks = masks.cpu()
    ...
    #python tools/detector_demo_maisha.py --root /home/airlab/mbird/GoProUpClose/0945.png --index 0945
